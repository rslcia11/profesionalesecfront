  ...
  return (
    <main className="min-h-screen bg-white font-sans selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-32">
        ...
        <section className="bg-gray-50 rounded-[3rem] p-12 md:p-20 border border-gray-100">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-gray-900 tracking-tighter mb-4 uppercase">SE PARTE DE PROFESIONALES.EC</h2>
            <p className="text-gray-400 font-light max-w-2xl mx-auto">Únete a la red de conocimiento más influyente del país y potencia tu carrera.</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {participationRoles.map((role, idx) => (
              <div key={idx} className="bg-white p-10 rounded-3xl border border-gray-100 hover:shadow-xl transition-all group">
                ...
                <p className="text-gray-400 text-xs font-light leading-relaxed mb-6">{role.description}</p>
                <Link 
