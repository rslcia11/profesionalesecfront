...
// Botón tipado (para evitar errores de TS)
...
// Lo saco fuera del componente (opcional pero recomendable)
const professionals: Record<string, Professional> = {
    ...
    "maria-torres": {
        ...
        description: "Especialista en desarrollo de software y transformación digital.",
    ...
    "ana-gutierrez": {
        ...
        services: ["Estudios ambientales", "Gestión de residuos", "Proyectos de sostenibilidad"],
    },
    "roberto-salazar": {
        id: "roberto-salazar",
        ...
        description: "Optimización de procesos, manufactura y logística.",
        experience: "10 años",
    ...
    "diego-ramirez": {
        ...
        description: "Experto en automatización, IoT y sistemas electrónicos.",
        experience: "9 años",
        certifications: ["CCNP", "Domótica", "IoT Specialist"],
        services: ["Automatización", "Diseño electrónico", "Instalación domótica"],
    },
}

export default function PerfilProfesional() {
    // Le decimos a TS que params tiene un "id" string
            ...
            <div className="min-h-screen bg-gray-50 pt-28 pb-16">
                <div className="max-w-6xl mx-auto px-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {professional.services.map((s, index) => (
