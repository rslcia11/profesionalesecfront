...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#0a0a0a] text-white flex flex-col">
      <Header />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
              <Card className="bg-gradient-to-br from-blue-500/10 to-blue-600/10 border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/10 hover:scale-105">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-sm font-medium text-gray-300">Conversatorios Activos</CardTitle>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
              <Card className="bg-gradient-to-br from-emerald-500/10 to-emerald-600/10 border-emerald-500/20 hover:border-emerald-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/10 hover:scale-105">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-sm font-medium text-gray-300">Perfiles Pendientes</CardTitle>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300">
              <Card className="bg-gradient-to-br from-amber-500/10 to-amber-600/10 border-amber-500/20 hover:border-amber-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/10 hover:scale-105">
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-white mb-1">{planes.filter((p) => p.activo).length}</div>
                  <p className="text-xs text-gray-400 flex items-center gap-1">
                    <TrendingUp className="h-3 w-3" />
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-white/5 border border-white/10 mb-8 p-1">
                <TabsTrigger
                  value="conversatorios"
                  className="data-[state=active]:bg-blue-500/20 data-[state=active]:text-blue-400 transition-all duration-200"
                >
                ...
                <TabsTrigger
                  value="planes"
                  className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-400 transition-all duration-200"
                >
                ...
                <div className="animate-in fade-in duration-300">
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">Crea, edita y administra tus eventos educativos</p>
                    </div>
                    <Dialog open={isConversatorioDialogOpen} onOpenChange={setIsConversatorioDialogOpen}>
                      <DialogTrigger asChild>
                        <Button
                          className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 shadow-lg shadow-blue-500/20 transition-all duration-300 hover:scale-105"
                          onClick={() => {
                            setEditingItem(null)
                            resetConversatorioForm()
                          }}
                      ...
                      <DialogContent className="bg-[#1a1a1a] border-white/10 max-w-2xl max-h-[90vh] overflow-y-auto">
                        <DialogHeader>
                          <DialogTitle className="text-xl">
                            {editingItem ? "Editar" : "Crear"} Conversatorio
                          </DialogTitle>
                        ...
                        <div className="grid gap-4 py-4">
                          <div className="grid gap-2">
                            ...
                            <Input
                              ...
                              className="bg-white/5 border-white/10 focus:border-blue-500/50 transition-colors"
                            />
                          </div>
                          <div className="grid gap-2">
                            ...
                            <Textarea
                              ...
                              className="bg-white/5 border-white/10 focus:border-blue-500/50 transition-colors min-h-[100px]"
                              rows={4}
                            />
                          </div>
                              ...
                              <Popover>
                                <PopoverTrigger asChild>
                                  <Button
                                    variant="outline"
                                    className={cn(
                                      "justify-start text-left font-normal bg-white/5 border-white/10 hover:bg-white/10 hover:border-blue-500/50 transition-colors",
                          ...
                          <div className="grid gap-2">
                            ...
                            >
                              <SelectTrigger className="bg-white/5 border-white/10 focus:border-blue-500/50 transition-colors">
                                <SelectValue />
                              </SelectTrigger>
                    ...
                    {perfilesPendientes.filter((p) => p.estado === "pendiente").length === 0 ? (
                      <Card className="bg-white/5 border-white/10">
                        <CardContent className="flex flex-col items-center justify-center py-12">
                          ...
                          <p className="text-sm text-gray-400">Todos los perfiles han sido revisados y procesados</p>
                        </CardContent>
                      </Card>
                    ) : (
                      perfilesPendientes
                        ...
                        .map((perfil, index) => (
                          <Card
                            key={perfil.id}
                            className="bg-white/5 border-white/10 hover:border-emerald-500/30 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4"
                ...
                <div className="animate-in fade-in duration-300">
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Crea y administra los planes de suscripción y pagos únicos
                      </p>
                    </div>
                    <Dialog open={isPlanDialogOpen} onOpenChange={setIsPlanDialogOpen}>
                      <DialogTrigger asChild>
                        <Button
                          className="bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 shadow-lg shadow-amber-500/20 transition-all duration-300 hover:scale-105"
                          onClick={() => {
                            setEditingItem(null)
                            resetPlanForm()
                          }}
                        ...
                        <div className="grid gap-4 py-4">
                          ...
                          <div className="grid gap-2">
                            ...
                            <Textarea
                              ...
                              className="bg-white/5 border-white/10 focus:border-amber-500/50 transition-colors min-h-[100px]"
                              rows={3}
                            />
                          </div>
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="grid gap-2">
                              ...
                              >
                                <SelectTrigger className="bg-white/5 border-white/10 focus:border-amber-500/50 transition-colors">
                                  <SelectValue />
                                </SelectTrigger>
                                <SelectContent className="bg-[#1a1a1a] border-white/10">
                  ...
                  <div className="grid gap-4">
                    {planes.map((plan, index) => (
                      <Card
                        key={plan.id}
                        className="bg-white/5 border-white/10 hover:border-amber-500/30 transition-all duration-300 animate-in fade-in slide-in-from-bottom-4"
                        style={{ animationDelay: `${index * 100}ms` }}
                      >
                        <CardHeader>
                          <div className="flex justify-between items-start">
                        ...
                        <CardContent>
                          ...
                          <div className="flex gap-3">
                            <Button
                              ...
                              variant="outline"
                              className="flex-1 bg-white/5 border-white/10 hover:bg-amber-500/20 hover:border-amber-500/50 transition-all duration-300 hover:scale-105"
                            >
