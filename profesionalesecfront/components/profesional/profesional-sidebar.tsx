...
export default function ProfesionalSidebar() {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-1 px-2 py-4 mt-16">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                hovered ? "gap-3 px-3" : "justify-center px-0",
                isActive
                  ? "text-white"
            ...
            >
              ...
              <span
                className="overflow-hidden transition-[opacity,width] duration-300 ease-in-out"
                style={{
                  opacity: hovered ? 1 : 0,
