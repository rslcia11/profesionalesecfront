...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      icon: Money,
      href: "/administracion", // Updated to navigate to new administracion page
    },
    {
      id: "oficios",
      title: "Oficios y más",
    ...
    },
    {
      ...
      icon: BookOpen,
      href: "/educacion", // Updated to navigate to new education page
    },
    {
      id: "ingenieria",
    ...
    },
    {
      ...
      icon: Palette,
      href: "/diseno-y-construccion", // Updated to navigate to new page
    },
    {
      id: "agraria",
      title: "Agraria",
