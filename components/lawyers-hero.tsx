  ...
  return (
    <section className="relative w-full h-screen flex items-center justify-center bg-black/40 overflow-hidden pt-20">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/professional-lawyer-office.jpg')`,
        }}
      />
      <div className="absolute inset-0 -z-10 bg-black/50" />

      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
        <div className="mb-6 text-emerald-400 font-medium text-sm tracking-widest">Los mejores abogados en Pec</div>
        ...
        <p className="text-lg text-white/70 mb-10 max-w-2xl mx-auto">
          Acceso a profesionales especializados en derecho penal, civil y laboral para resolver tus casos legales.
        </p>
